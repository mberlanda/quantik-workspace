...
that session needing the cross-repo context in [`WORKSTREAMS.md`](../docs/history/workstreams-archive.md).
...
packages and belong in a session that holds the whole workspace. See [`WORKSTREAMS.md`](../docs/history/workstreams-archive.md).
