...
`docs/learning-rate-sweep.md` and the warning box in `WORKSTREAMS.md` §11 before
...
Both are recorded in `WORKSTREAMS.md` §11 and in `docs/retrain-and-finetune.md`:
...
`WORKSTREAMS.md` §11, `docs/shift-evaluation.md` and `docs/autoplay.md`. Every one of
...
- `WORKSTREAMS.md` §11 — "A second methodological flaw", and the learning-rate warning box
