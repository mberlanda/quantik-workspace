...
def validate_generated(config: WorkspaceConfig) -> dict[str, Any]:
    expected = {
        ...
        config.root / "docs/generated/dispatch-board.md": dispatch_board_markdown(config),
        config.root / "docs/generated/dispatch-board.json": dump_data(
            {"schema": "quantik-dispatch-board.v1", "work_items": dispatch_board(config)}),
    }
