...
**All four repos now have real, tested changes submitted.** Three are
merged; `quantik-models-py#63` is open pending CI and review. QW-001's
acceptance criteria are met once that PR merges (or once a decision is made
about the two version-gated tests, whichever the maintainer prefers).
